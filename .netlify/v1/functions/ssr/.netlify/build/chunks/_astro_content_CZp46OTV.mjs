...
import { z } from "zod";
import { b as removeBase, i as isRemotePath, p as prependForwardSlash } from "./path_GX_qhJUV.mjs";
import { V as VALID_INPUT_FORMATS } from "./consts_UaXOePs0.mjs";
import { A as AstroError, U as UnknownContentCollectionError, c as createComponent, R as RenderUndefinedEntryError, u as unescapeHTML, b as renderTemplate, i as renderUniqueStylesheet, j as renderScriptElement, k as createHeadAndContent, r as renderComponent } from "./astro/server_C7Z9Vbd7.mjs";
import "kleur/colors";
...
class ImmutableDataStore {
  ...
  static async fromModule() {
    try {
      const data = await import("./_astro_data-layer-content_-26xhjk1.mjs");
...
async function updateImageReferencesInBody(html, fileName) {
  ...
  const { getImage } = await import("./_astro_assets_DKE-QtcE.mjs");
...
async function renderEntry(entry) {
  ...
  if (entry.deferredRender) {
    try {
      const { default: contentModules } = await import("./content-modules_DlCOOl0W.mjs");
