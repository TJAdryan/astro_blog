...
TEXT_PARTS = [
    ...
    ("It was a September day in Brooklyn that felt like a gift—the kind of weather where the sun is bright but the air is crisp, signaling the perfect start to something new. On this morning, the light seemed to shine specifically for Dominick and Sophio.", VOICE_STORYBOOK),
